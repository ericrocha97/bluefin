...
- **Ferramentas do Sistema**: earlyoom (prevenção de OOM), ffmpegthumbnailer (thumbnails de vídeo), util-linux-user (utilitários adicionais do sistema como `runuser` e `sulogin`)

...
export DOCKERHUB_REPO="ericrocha/bluefin-cosmic-dx"
...
assert_file_contains "$RELEASE_BODY_FILE" "[View on Docker Hub](https://hub.docker.com/r/ericrocha/bluefin-cosmic-dx)"
